...
WMO_DESCRIPTIONS = {
    ...
    1:  ("Ueberwiegend klar",   "mostly clear sky, few clouds"),
    2:  ("Teilweise bewoelkt",  "partly cloudy sky, scattered clouds"),
    3:  ("Bedeckt",             "overcast cloudy sky"),
    45: ("Nebel",               "foggy misty atmosphere"),
    48: ("Raureif-Nebel",       "freezing fog"),
    51: ("Leichter Nieseln",    "light drizzle, wet streets"),
    53: ("Nieseln",             "drizzle, grey wet weather"),
    55: ("Starkes Nieseln",     "heavy drizzle, dark grey sky"),
